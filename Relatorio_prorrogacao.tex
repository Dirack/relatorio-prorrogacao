...
\vspace*{2cm}{\ABNTEXchapterfont\bfseries\large{RELATÓRIO DO PEDIDO DE PRORROGAÇÃO DE TESE DE DOUTORADO}}
\vspace*{\fill}\\
...
\begin{center}
	...
	{\ABNTEXchapterfont\bfseries\large\imprimirtitulo}\\
	 \vspace{\baselineskip}
	{\ABNTEXchapterfont\bfseries\large{RELATÓRIO DO PEDIDO DE PRORROGAÇÃO DE TESE DE DOUTORADO}}
	\vspace{\baselineskip}
	\vspace{\baselineskip}
	\vspace*{\fill}
...
\include{introducao}
\include{modelagem} % Método CRE fundamentos teóricos
\include{inversao} % Otimização global VFSA
\include{primeira} % Teoria intepolação com filtros PEF
